|                                                                                                                                                                                                                                                                                                                                             |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A keyword is a reserved word. You cannot use it as a variable name, constant name etc.<br><br>In C# keywords cannot be used as identifiers. However, if we want to use the keywords as identifiers, we may prefix the keyword with @ character.<br><br>**A list of Reserved Keywords available in C# programming language is given below:** |
